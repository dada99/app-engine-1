...
CALLBACK_URL = 'http://dada-app1.appspot.com'
RESOURCE_URL= 'https://www.googleapis.com/buzz/v1/activities/116647377615478411020/@consumption'
SCOPE_URL='https://www.googleapis.com/auth/buzz'
# key and secret granted by the service provider for this consumer application - same as the MockOAuthDataStore
CONSUMER_KEY = 'dada-app1.appspot.com'
CONSUMER_SECRET = 'iSKBR4pscs40NxXeRXSBlIhf'
...
def run_example():
    ...
    pause()
    oauth_request = oauth.OAuthRequest.from_consumer_and_token(consumer, callback=CALLBACK_URL, http_url=client.request_token_url,scope=SCOPE_URL)
    ...
    import urlparse, cgi
    query = urlparse.urlparse(response)
    print query
